...
public class JwtUtil{
	...
	public String generateToken(UserDetails userDetails) {
		...
		UserTemp user = uodvService.findUserByUserNameFromDatabase(userDetails.getUsername());		
	...
	private String doGenerateToken(Map<String, Object> claims, String subject) {
		...
		return Jwts.builder().setClaims(claims).setSubject(subject).setIssuedAt(new Date(System.currentTimeMillis()))
				.setExpiration(new Date(System.currentTimeMillis() + JWT_TOKEN_VALIDITY * 1000*60*60))
	...
	//start changes add by nipun dilhan
	public Claims getAllClaimsFromTokenMyMethod(String token) {
